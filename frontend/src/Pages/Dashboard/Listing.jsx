...
const Listing = () => {
  ...
  return (
    <main className="w-full max-w-screen-xl mx-auto px-3 sm:px-8 md:px-10 xl:px-20 pb-10">
      <section className="pt-6 sm:pt-8 flex flex-col gap-5 sm:gap-6 w-full max-w-full">
        {/* about listings */}
        <div className="flex flex-row justify-between items-center">
          ...
          <Link
            to="/become-a-host"
            className="flex flex-row items-center gap-1.5 text-xs sm:text-sm font-bold px-3.5 py-2 sm:px-4 sm:py-2.5 bg-white dark:bg-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-700 border border-neutral-300 dark:border-neutral-700 text-[#111827] dark:text-white rounded-xl shadow-xs transition-all cursor-pointer"
          >
            <HiPlus size={16} />
            Create listing
          </Link>
